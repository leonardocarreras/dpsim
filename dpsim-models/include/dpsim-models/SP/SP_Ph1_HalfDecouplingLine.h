...
/// SP::Ph1::DecouplingLine and can live in different systems or simulators.
...
protected:
  ...
  std::shared_ptr<SP::Ph1::ControlledCurrentSource> mSubCtrledCurrentSource;
  /// Terminating impedance calculated from line parameters
  std::shared_ptr<SP::Ph1::Resistor> mSubRes;
