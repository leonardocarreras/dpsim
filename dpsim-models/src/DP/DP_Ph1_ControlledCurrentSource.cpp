...
DP::Ph1::ControlledCurrentSource::ControlledCurrentSource(String name, Complex current,
                                      Logger::Level logLevel)
    : ControlledCurrentSource(name, logLevel) {
  setParameters(current);
}

void DP::Ph1::ControlledCurrentSource::setParameters(Complex current) {
  **mCurrentRef = current;
  mParametersSet = true;
}
...
void DP::Ph1::ControlledCurrentSource::updateCurrent() {
  (**mIntfCurrent)(0, 0) = **mCurrentRef;
